  ...
  return (
    <div className="max-w-5xl mx-10 lg:mx-auto py-10 space-y-7 ">
      ...
      >
        ...
        <TabItem label="Number of Students:" content="950" />
        <TabItem label="Category:" content="A" />
        <TabItem
          label="Contacts:"
          content="Box Address: P.O.Box 45 Achimota, Accra"
        />
        <TabItem label="Email:" content="achimotasch.edu@gmail.com" />
        <TabItem
          label="Telephone:"
          content="+233 24 458 0050 / +233 20 512 5675"
        />
        <TabItem label="Location:" content="Accra" />
      </a>

      <div>
        <Image
          src="/images/achimota/achimota.jpg"
          alt="achimota"
          width={900}
          height={500}
          objectFit="cover"
      ...
      <div className="space-y-4  ">
        ...
        <p className="text-lg">
          ...
          the time of the school's Golden Jubilee in 1960. There were over 1500
...
export default AchimotaDetailPage;
